...
public class SuperHeroRoster {
    ...
    public static void main(String[] args) {
        ...
        heroNames = new String[]{"Spider-Man", "Iron Man", "Captain America", "Thor", "Hulk"};
        abilities = new String[]{"Web-slinging", "Flying and high-tech armor", 
                               "SuperHuman Abilities and combat", "God of Thunder", "Super strength"};
        powerLevels = new int[]{55, 40, 35, 65, 68};
